...
contract Ballot {
    ...
    struct Student {
        uint matricNo; // student matric number
    ...
    */
    ...
    /** 
     * @dev Give public people to register as voter.
     * @param matricNo of student
     */
    function registerAsVoter(uint matricNo) public {
        require(!isThisAddressRegistered[msg.sender], "You have been registered");

        isThisAddressRegistered[msg.sender] = true;
        student.push(Student({
            studentWalletAddress: msg.sender,
            matricNo: matricNo
        }));
    }
    ...
    function giveRightToVote(address voter) public {
        require(isThisAddressRegistered[voter], "This address has not been registered");
        ...
        require(voters[voter].weight == 0, "This address already been given right to vote with weight of 1");
